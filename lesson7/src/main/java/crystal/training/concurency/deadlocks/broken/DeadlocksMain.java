package crystal.training.concurency.deadlocks.broken;

public class DeadlocksMain {
  // acc1 - 100 - debit 80 twice
...
class BankTransaction {
  ...
  public void execute() {
    synchronized (debitAccount) {
      ...
      // T1 - waiting to get into synchronized(creditAccount - "B") - having debitAccount already locked "A"
      // T2 - waiting to get into synchronized(creditAccount - "A") - having debitAccount already locked "B"
